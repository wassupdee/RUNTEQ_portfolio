...
### 差別化ポイント
#### メイン
- 「疎遠になった友だち」に送るメッセージを、AIが提案するサービスを提供している点
- 誕生日・大切な日のリマインド通知は、LINEのメッセージで届くため、設定をONにする必要があるプッシュ通知と違い、快適に活用できる点
- 上記に加えて、プロフィールやアルバム作成機能を備えている点

#### サブ
- 通知のタイミングを、誕生日・大切な日の最長60日前に設定できる為、イベントやプレゼントの準備の時間を確保しやすい点（競合は最長1週間前）
...
[![Image from Gyazo](https://i.gyazo.com/9ea06d5a1b6e6836988e595c65f2978b.png)](https://gyazo.com/9ea06d5a1b6e6836988e595c65f2978b)
